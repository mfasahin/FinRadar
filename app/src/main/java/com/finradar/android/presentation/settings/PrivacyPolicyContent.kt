...
object PrivacyPolicyContent {
    ...
    fun getLastUpdated(lang: String) = when (lang) {
        "tr" -> "Son Güncelleme: 14 Nisan 2026"
        "de" -> "Zuletzt aktualisiert: 14. April 2026"
        "fr" -> "Dernière mise à jour : 14 avril 2026"
        "es" -> "Última actualización: 14 de abril de 2026"
        "ar" -> "آخر تحديث: 14 أبريل 2026"
        "zh" -> "最后更新：2026年4月14日"
        "ja" -> "最終更新日：2026年4月14日"
        "ru" -> "Последнее обновление: 14 апреля 2026 г."
        else -> "Last Updated: April 14, 2026"
    }
    ...
    fun getSections(lang: String) = when (lang) {
        "tr" -> listOf(
            ...
            "4. İzinler" to "Uygulama, temel işlevlerini yerine getirmek için 'Bildirim Erişimi' iznini talep eder. Bu izin sadece yerel analiz için kullanılır.",
        ...
        "de" -> listOf(
            ...
            "4. Berechtigungen" to "Die App fordert die Berechtigung 'Benachrichtigungszugriff' an, um ihre Grundfunktionen zu erfüllen. Diese Berechtigung wird nur für die lokale Analyse verwendet.",
        ...
        "fr" -> listOf(
            ...
            "4. Autorisations" to "L'application demande l'autorisation 'Accès aux notifications'. Celle-ci est utilisée uniquement pour l'analyse locale.",
        ...
        "es" -> listOf(
            ...
            "4. Permisos" to "La aplicación solicita el permiso 'Acceso a notificaciones'. Este se utiliza únicamente para el análisis local.",
        ...
        "ar" -> listOf(
            ...
            "4. الأذونات" to "يطلب التطبيق إذن 'الوصول إلى الإشعارات'. يُستخدم هذا الإذن فقط للتحليل المحلي.",
        ...
        "zh" -> listOf(
            ...
            "4. 权限" to "应用程序请求\"通知访问\"权限，该权限仅用于本地分析。",
        ...
        "ja" -> listOf(
            ...
            "4. パーミッション" to "アプリは「通知アクセス」権限を要求します。これはローカル分析のみに使用されます。",
        ...
        "ru" -> listOf(
            ...
            "4. Разрешения" to "Приложение запрашивает разрешение «Доступ к уведомлениям». Оно используется исключительно для локального анализа.",
            ...
            "4. Permissions" to "The app requests 'Notification Access' permission. This is used solely for local analysis.",
