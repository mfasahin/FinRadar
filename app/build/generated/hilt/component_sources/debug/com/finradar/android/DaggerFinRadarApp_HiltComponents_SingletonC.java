...
public final class DaggerFinRadarApp_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends FinRadarApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideSmsParserProvider = DoubleCheck.provider(new SwitchingProvider<SmsParser>(singletonCImpl, 7));
      this.provideTransactionDaoProvider = DoubleCheck.provider(new SwitchingProvider<TransactionDao>(singletonCImpl, 9));
      ...
      this.provideSubscriptionDetectorProvider = DoubleCheck.provider(new SwitchingProvider<SubscriptionDetector>(singletonCImpl, 10));
      this.providePriceHikeDetectorProvider = DoubleCheck.provider(new SwitchingProvider<PriceHikeDetector>(singletonCImpl, 11));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 7: // com.finradar.android.data.parser.SmsParser 
          return (T) AppModule_ProvideSmsParserFactory.provideSmsParser();

          case 8: // com.finradar.android.domain.repository.TransactionRepository 
          ...
          case 9: // com.finradar.android.data.local.dao.TransactionDao 
          return (T) AppModule_ProvideTransactionDaoFactory.provideTransactionDao(singletonCImpl.provideAppDatabaseProvider.get());

          case 10: // com.finradar.android.domain.usecase.SubscriptionDetector 
          ...
          case 11: // com.finradar.android.domain.usecase.PriceHikeDetector 
