...
import com.finradar.android.presentation.pending.PendingSubscriptionViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.finradar.android.worker.PaymentReminderWorker_AssistedFactory;
...
public final class DaggerFinRadarApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends FinRadarApp_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(5).add(AlertsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(DashboardViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(PendingSubscriptionViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SettingsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SubscriptionsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.finradar.android.presentation.pending.PendingSubscriptionViewModel 
  ...
  private static final class SingletonCImpl extends FinRadarApp_HiltComponents.SingletonC {
    ...
    private Provider<PaymentReminderWorker_AssistedFactory> paymentReminderWorker_AssistedFactoryProvider;
    ...
    private Map<String, javax.inject.Provider<WorkerAssistedFactory<? extends ListenableWorker>>> mapOfStringAndProviderOfWorkerAssistedFactoryOf(
      ...
      return Collections.<String, javax.inject.Provider<WorkerAssistedFactory<? extends ListenableWorker>>>singletonMap("com.finradar.android.worker.PaymentReminderWorker", ((Provider) paymentReminderWorker_AssistedFactoryProvider));
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideSubscriptionDaoProvider = DoubleCheck.provider(new SwitchingProvider<SubscriptionDao>(singletonCImpl, 2));
      this.provideSubscriptionRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SubscriptionRepository>(singletonCImpl, 1));
      ...
      this.providePriceHikeDetectorProvider = DoubleCheck.provider(new SwitchingProvider<PriceHikeDetector>(singletonCImpl, 12));
    }

    @Override
    public void injectFinRadarApp(FinRadarApp finRadarApp) {
      injectFinRadarApp2(finRadarApp);
    }
    ...
    @CanIgnoreReturnValue
    private FinRadarApp injectFinRadarApp2(FinRadarApp instance) {
      FinRadarApp_MembersInjector.injectWorkerFactory(instance, hiltWorkerFactory());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.finradar.android.worker.PaymentReminderWorker_AssistedFactory 
          return (T) new PaymentReminderWorker_AssistedFactory() {
            @Override
            public PaymentReminderWorker create(Context context, WorkerParameters workerParams) {
              return new PaymentReminderWorker(context, workerParams, singletonCImpl.provideSubscriptionRepositoryProvider.get(), singletonCImpl.userPreferencesRepositoryProvider.get(), singletonCImpl.provideAlertRepositoryProvider.get());
            }
          };

          case 1: // com.finradar.android.domain.repository.SubscriptionRepository 
          ...
          case 2: // com.finradar.android.data.local.dao.SubscriptionDao 
          ...
          case 4: // com.finradar.android.data.preferences.UserPreferencesRepository 
          ...
          case 10: // com.finradar.android.data.local.dao.TransactionDao 
          return (T) AppModule_ProvideTransactionDaoFactory.provideTransactionDao(singletonCImpl.provideAppDatabaseProvider.get());

          case 11: // com.finradar.android.domain.usecase.SubscriptionDetector 
          ...
          case 12: // com.finradar.android.domain.usecase.PriceHikeDetector 
